...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        # Give alarm when distance is less than 3.5 meter.
        if d < 3.5:
            playsound(u"./yolo3/alert.wav")
...
def detect_video(yolo, video_path, output_path=""):
    vid = cv2.VideoCapture('./input_video/traffic_test.mp4')
    if not vid.isOpened():
    ...
    while True:
        ...
        warning = 'An alarm wil fire when distance of nearest vehicle from our vehicle will be less than 3.5 meter.'
        cv2.putText(result, warning, org=(20, 30), fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                    fontScale=0.50, color=(255, 0, 0), thickness=2)
